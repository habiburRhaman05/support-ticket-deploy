    ...
    <div className="min-h-screen bg-[#F5F7FA] flex items-center justify-center px-4">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-sm border border-gray-100 p-8 text-center">
        <div className="flex items-center justify-center gap-2 mb-8">
          ...
          <span className="text-lg font-bold text-gray-900">Support Portal</span>
        </div>

        {state.kind === "loading" && (
          <>
            <Loader2 className="w-10 h-10 text-blue-600 animate-spin mx-auto mb-4" />
            <h1 className="text-lg font-semibold text-gray-900">Checking your access…</h1>
            <p className="text-sm text-gray-500 mt-2">One moment while we verify your account.</p>
          </>
        )}
