...
const DEMO_CREDENTIALS = [
  { label: "Agency Owner", email: "admin@demo.com", password: "password123" },
  { label: "Team Member", email: "sam@demo.com", password: "password123" },
  { label: "Team Member", email: "kai@demo.com", password: "password123" },
]
          ...
          <div className="mt-4 grid gap-2">
            {DEMO_CREDENTIALS.map((demo) => (
              <button
                ...
                className="flex items-center justify-between px-4 py-2.5 rounded-xl border border-gray-100 bg-gray-50 hover:bg-gray-100 transition-colors text-left"
              >
                <span className="text-sm font-medium text-gray-700">{demo.label}</span>
                <span className="text-xs text-gray-400 font-mono">Fill credentials</span>
              </button>
            ))}
          </div>
        </div>
